 ...
 */
class GLPagerConfig(
    private val viewer: GLPagerViewer,
    ...
    private fun zoomTypeFromPreference(value: Int) {
        imageZoomType = when (value) {
            // Auto
            1 -> when (viewer) {
                is L2RGLPagerViewer -> ReaderPageImageView.ZoomStartPosition.LEFT
                is R2LGLPagerViewer -> ReaderPageImageView.ZoomStartPosition.RIGHT
    ...
    override var navigator: ViewerNavigation = RightAndLeftNavigation()
        set(value) {
